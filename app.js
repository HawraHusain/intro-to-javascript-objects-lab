...
const pokemon2=pokemon.find(p=>p.name === "Raticate")
const pokemon3=pokemon.find(p=>p.name === "Pikachu")
...
function evolvePokemonInParty(pokemonName, evolvedPokemon) {
    const pokemonIndex = game.party.findIndex(p => p.name === pokemonName);
    if (pokemonIndex !== -1) {
      game.party.splice(pokemonIndex, 1, evolvedPokemon);
    }
  }
  evolvePokemonInParty("Metapod", evolvedMetapod);
evolvePokemonInParty("Raticate", evolvedRaticate);
evolvePokemonInParty("Pikachu", evolvedPikachu);
